...
class TankDown extends StatefulWidget {
  const TankDown({super.key});

  @override
  State<TankDown> createState() => _TankDownState();
}

class _TankDownState extends State<TankDown> {
  int selectindex = 0;
  String? nametank;
  @override
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              gas_km[index]['sum2'] = gas_km[index]['originalSum2'] ?? '';
                                              // controller[index].text = NumberFormat('#,##0', 'en_US').format(int.parse(gas_km['originalSum1'] ?? '0'));
                                            });
                                          },
                                          child: Container(
